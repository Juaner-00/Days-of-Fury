...
{
    //for AI
    [SerializeField] bool AI;                   //  AI ON/OFF
    [SerializeField] bool AlwaysMove;
    [SerializeField] bool Turret_Turn;                  //Turn ON/OFF
    [SerializeField] Transform[] targetPointsPos;                   //(enemy AI) Points for positions 
                                                                    //(enemy AI) selected targetPointPos in array
    [SerializeField] float m_Speed = 8.0f;                 // How fast the tank moves forward and back.
    [SerializeField] float m_TurnSpeed = 180f;            // How fast the tank turns in degrees per second.
    [SerializeField] int currentHealth = 50;            //The tank's current health point total

    [SerializeField] float m_PitchRange = 0.2f;           // The amount by which the pitch of the engine noises can vary.

    [SerializeField] AudioClip tank_idle;
    [SerializeField] AudioClip tankDead;

    [SerializeField] float EnemyRangeFire = 50;
    [SerializeField] Rigidbody shell;

    [SerializeField] float FireRate = 0.5f;                 // Number in seconds which controls how often the player can fire
    [SerializeField] float speedShell = 80f;

    [SerializeField] Transform Turret;
    [SerializeField] Transform Barrel;
    [SerializeField] Transform GunEnd;

    [SerializeField] ParticleSystem m_smokeBarrel;
    [SerializeField] ParticleSystem m_smokeDead;
    [SerializeField] ParticleSystem m_tankExplosion;
    ...
    private byte sel_ltargetPointPos;
